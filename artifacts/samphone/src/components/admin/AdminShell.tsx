...
const MANAGE = [
  { href: "/admin/pricing", label: "Pricing & discounts", Icon: Percent },
  { href: "/admin/catalog", label: "Advanced tools", Icon: SlidersHorizontal },
];
    ...
    <div className="flex min-h-[calc(100dvh-var(--site-header-h,9rem))] bg-[#F4F6FB]">
      <aside className="hidden w-[15.5rem] shrink-0 flex-col bg-brand-dark text-white md:flex">
        ...
        <nav className="mt-4 flex-1 space-y-6 px-3 pb-6">
          ...
          <div>
            <p className="mb-2 px-2 text-[10px] font-bold uppercase tracking-[0.18em] text-white/40">Manage</p>
            <div className="space-y-0.5">
              {MANAGE.map((item) => {
