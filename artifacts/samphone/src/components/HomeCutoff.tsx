  ...
  return (
    <section className="py-8 md:py-10">
      <div className="mx-auto w-full max-w-[1600px] px-5 sm:px-8 md:px-10 lg:px-14 xl:px-16">
        <h2 className="mb-4 font-display text-2xl font-bold text-navy md:text-[2rem]">{t("cutoff_title")}</h2>
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          <div className="rounded-xl bg-white p-5 shadow-sm ring-1 ring-black/[0.04]">
            ...
            <p className="mt-3 font-display text-4xl font-bold text-navy">{t("cutoff_time")}</p>
          ...
          <div className="rounded-xl bg-white p-5 shadow-sm ring-1 ring-black/[0.04]">
            ...
            <p className="mt-3 font-display text-2xl font-bold text-navy">{t("cutoff_shipping_value")}</p>
            <p className="mt-2 text-sm text-muted-foreground">{t("cutoff_shipping_hint")}</p>
          </div>
          <div className="rounded-xl bg-white p-5 shadow-sm ring-1 ring-black/[0.04] sm:col-span-2 lg:col-span-1">
            <p className="text-xs font-semibold uppercase tracking-wider text-muted-foreground">{t("cutoff_support")}</p>
            <p className="mt-3 font-display text-2xl font-bold text-navy">{t("phone")}</p>
