  ...
  return (
    <AdminShell title={title} pendingCustomers={pending}>
      ...
      <p className="mt-1 text-sm text-neutral-500">
        {channel === "b2b"
          ? "Approved business accounts from the shop, samphone.pt, samphone.eu, or the app. Products show wholesale prices."
          : "Personal shopper accounts. Products show public B2C prices."}
      </p>
