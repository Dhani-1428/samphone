    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          "Admin can set a flat account discount % for a specific customer",
          "Admin can also add discounts for a particular product or category on that account",
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          "O admin pode definir um desconto % para uma conta específica",
          "O admin também pode dar desconto a um produto ou categoria nessa conta",
