/** Model lists copied from the live samphone.pt brand menus. */
...
export const SAMSUNG_A_SERIES_MODELS = [
...
export const SAMSUNG_S_SERIES_MODELS = [
  ...
  "Samsung Galaxy S20 FE (G780/781)",
...
export const SAMSUNG_Z_SERIES_MODELS = [
...
export const SAMSUNG_M_SERIES_MODELS = [
...
export const SAMSUNG_J_SERIES_MODELS = [
...
export const SAMSUNG_NOTE_SERIES_MODELS = [
...
export const XIAOMI_REDMI_SERIES_MODELS = [
...
export const XIAOMI_POCO_SERIES_MODELS = [
  "Xiaomi Poco X7 Pro",
  "Xiaomi Poco X7",
  "Xiaomi Poco X6 Neo",
  "Xiaomi Poco X6 Pro",
...
export const XIAOMI_REDMI_NOTE_SERIES_MODELS = [
...
export const XIAOMI_MI_SERIES_MODELS = [
  "Xiaomi 17 Pro Max",
  "Xiaomi 17 Pro",
  "Xiaomi 17",
  "Xiaomi 15 Ultra",
...
export const OPPO_RENO_SERIES_MODELS = [
  "Oppo Reno 14 Pro 5G",
  "Oppo Reno 14 FS 5G",
  "Oppo Reno 14 F",
  "Oppo Reno 14 5G",
...
export const OPPO_A_SERIES_MODELS = [
  "Oppo A40",
  "Oppo A40m (CPH2669)",
  "Oppo A80 (CPH2639)",
  "Oppo A3 Pro (CPH2639)",
  ...
  "Oppo A7 (АХ7)(CPH1901,CPH1903,CPH1905)",
...
export const OPPO_F_SERIES_MODELS = [
  "Oppo F19",
...
export const OPPO_FIND_X_SERIES_MODELS = [
  "Oppo Find X9",
  "Oppo Find X9 Pro",
  "Oppo Find X8 Ultra",
...
export const REALME_C_SERIES_MODELS = [
  "Realme C61",
  "Realme C63",
  "Realme C65",
  "Realme C67 5G",
...
export const REALME_NUMBER_SERIES_MODELS = [
  "Realme 12 4G",
  "Realme 12x",
  "Realme 12 Plus",
  "Realme 12 5G",
...
export const REALME_NARZO_SERIES_MODELS = [
...
export const HUAWEI_P_SERIES_MODELS = [
...
export const HUAWEI_Y_SERIES_MODELS = [
  "Huawei Y9A",
  "Huawei Y7A",
  "Huawei Y8S",
  "Huawei Y8P",
...
export const HUAWEI_HONOR_SERIES_MODELS = [
  "Huawei Honor Play",
  "Huawei Honor 6",
  "Huawei Honor 6A",
  "Huawei Honor 6C",
...
export const HUAWEI_MATE_SERIES_MODELS = [
  "Huawei Mate 30",
  "Huawei Mate 30 Lite",
  "Huawei Mate 30 Pro",
  "Huawei Mate 20X",
...
export const HUAWEI_NOVA_SERIES_MODELS = [
  "Huawei Nova 12 SE",
  "Huawei Nova 12s",
  "Huawei Nova 12i",
  "Huawei Nova 12",
...
export const ONEPLUS_SERIES_MODELS = [
  "OnePlus 13R",
  "OnePlus 13",
  "OnePlus 12R",
  "OnePlus 12",
...
export const ONEPLUS_NORD_SERIES_MODELS = [
  "OnePlus 11",
...
export const TCL_SERIES_MODELS = [
  "TCL 60 5G",
  "TCL 60 SE",
  "TCL 60 XE",
  "TCL 60R 5G",
...
export const ZTE_SERIES_MODELS = [
  "ZTE A5 2020",
  "ZTE A7S",
  "ZTE A7 2019",
  "ZTE A7 2020 BLACK",
...
export const VIVO_SERIES_MODELS = [
  "Vivo Y11",
  "Vivo Y12",
  "Vivo Y15",
  "Vivo Y17",
...
export const NOKIA_SERIES_MODELS = [
  "Nokia X20",
  "Nokia X10",
  "Nokia C20",
  "Nokia C10",
...
export const GOOGLE_PIXEL_SERIES_MODELS = [
  "Google Pixel 10A",
...
export const LG_SERIES_MODELS = [
  "LG K51S",
  "LG K42S",
  "LG K41S",
  "LG K40S",
  "LG K30",
  "LG K30 2019 (LM-X320)/Aristo 4",
  "LG K61",
  "LG K60S",
  "LG K20 2019 (LM-X120)",
  "LG K51/Q51",
  ...
  "LG K41/Harmony K400",
  "LG K40 (LM-X420)",
  "LG K20 (LM-K200)/K22 2020",
  "LG K50 (LM-X520)/ Q60 (LM-525)",
  "LG K31/Aristo 5",
  "LG K92 5G",
  "LG Q92 5G",
  "LG K12",
...
export const TABLET_IPADS_MODELS = [
...
export const TABLET_TCL_MODELS = [
  "TCL Tab 10 Gen2",
  "TCL Tab 10L",
];

export const TABLET_LENOVO_MODELS = [
...
export const TABLET_SAMSUNG_MODELS = [
  ...
  "Samsung Galaxy Tab S10 FE (X520/526)",
...
export const TABLET_XIAOMI_MODELS = [
  "Xiaomi Pad SE 8.7",
  "Xiaomi Pad SE 11.0",
  "Xiaomi Pad Pro 12.1",
...
export const TABLET_HUAWEI_MODELS = [
